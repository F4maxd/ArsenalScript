...
local f4maxloader = Instance.new("TextLabel")
...
f4maxloader.Name = "f4maxloader"
f4maxloader.Parent = Loader
f4maxloader.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
f4maxloader.BackgroundTransparency = 1.000
f4maxloader.BorderColor3 = Color3.fromRGB(0, 0, 0)
f4maxloader.BorderSizePixel = 0
...
f4maxloader.TextTransparency = 1
...
local pop = ts:Create(f4maxloader, TweenInfo.new(1), {TextTransparency = 0})
pop:Play()
...
local trans = ts:Create(f4maxloader, TweenInfo.new(1.5), {TextTransparency = 1})
trans:Play()
...
local UICorner_3 = Instance.new("UICorner")
local f4maxname = Instance.new("TextLabel")
...
f4maxname.Name = "f4maxname"
f4maxname.Parent = Title
f4maxname.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
f4maxname.BackgroundTransparency = 1.000
f4maxname.BorderColor3 = Color3.fromRGB(0, 0, 0)
f4maxname.BorderSizePixel = 0
